...
def HLT_cut(file, arrays):
	HLT_SingleMuon 		= arrays['HLT_IsoMu27'] == True
	HLT_DoubleMuon 		= arrays['HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8']
	HLT_SingleElectron  = arrays['HLT_Ele32_WPTight_Gsf_L1DoubleEG'] == True
	HLT_DoubleEG 		= arrays['HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL'] == True
	HLT_MuonEG1 		= arrays['HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ'] == True
	HLT_MuonEG2 		= arrays['HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ'] == True
