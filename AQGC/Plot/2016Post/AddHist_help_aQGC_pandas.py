...
def AddHist(file, hist, isData, xsec, lumi, channel, branch):
	...
	if isData:
		...
		if file_basename == "LLWA_aQGC_UL16Post_Skim.root":
	...
	print('Finished adding branches')
	...
	print('Finished applying basic cuts, building kinematic variables')
	if isData:
		...
		# skip btag weight for modified method
		#arrays['btagWeight'] = arrays['btagWeight'].apply(lambda x: 1 if x==0 else x)


		print("Cuts and weights applied to MC files")
		...
		if file_basename == "LLWA_aQGC_UL16Post_Skim.root":
			...
			for i in range(len_weight):
				...
				arrays[f'true_weight_Rwt{i}'] = arrays['puWeight'] * arrays['Muon_ID_Weight'] * arrays['Electron_ID_Weight'] * arrays['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays['Generator_weight_sgn'] / true_events
				if channel in [0,1,2,3,4, 10,11,12,13,14, 20,21,22,23,24, 30,31,32]:
				...
				arrays_copy_nominal['true_weight_MuonIDup_Rwt{i}'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight_UP'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_MuonIDdown_Rwt{i}'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight_DOWN'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronIDup_Rwt{i}'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight_UP'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronIDdown_Rwt{i}'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight_DOWN'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronRECOup_Rwt{i}'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight_UP'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronRECOdown_Rwt{i}'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight_DOWN'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_puup_Rwt{i}'] = arrays_copy_nominal['puWeightUp'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_pudown_Rwt{i}'] = arrays_copy_nominal['puWeightDown'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				for branch_name in branch:
		...
		#------------->  Non-Reweight
			...
			# skip b-tag weight -new mehtod will be implemented-
			arrays['true_weight'] = arrays['puWeight'] * arrays['Muon_ID_Weight'] * arrays['Electron_ID_Weight'] * arrays['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays['Generator_weight_sgn'] / true_events
			...
			print("Filling up down:")
			arrays_copy_nominal['true_weight_MuonIDup'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight_UP'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_MuonIDdown'] = arrays_copy_nominal['puWeight'] *  arrays_copy_nominal['Muon_ID_Weight_DOWN'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronIDup'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight_UP'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronIDdown'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight_DOWN'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronRECOup'] = arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight_UP'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronRECOdown'] = arrays_copy_nominal['puWeight'] *  arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight_DOWN'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_puup'] = arrays_copy_nominal['puWeightUp'] *  arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_pudown'] = arrays_copy_nominal['puWeightDown'] *  arrays_copy_nominal['Muon_ID_Weight'] * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			for branch_name in branch:
