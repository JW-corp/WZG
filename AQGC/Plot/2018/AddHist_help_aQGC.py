...
def HLT_cut(file, arrays):
	HLT_SingleMuon_mask  = arrays['HLT_IsoMu24'] == True
	HLT_DoubleMuon_mask  = arrays['HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8'] == True
	HLT_EGamma_mask 	 = arrays['HLT_Ele32_WPTight_Gsf'] == True
	HLT_DoubleEG_mask	 = arrays['HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL'] == True
	HLT_MuonEG1_mask 	 = arrays['HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ'] == True
	HLT_MuonEG2_mask 	 = arrays['HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL'] == True

	if 'SingleMuon' in file:
		arrays = arrays[HLT_SingleMuon_mask]
	elif 'DoubleMuon' in file:
		arrays = arrays[~HLT_SingleMuon_mask & HLT_DoubleMuon_mask]
#		 2018 is special
	elif 'EGamma' in file:
		arrays = arrays[~HLT_SingleMuon_mask & ~HLT_DoubleMuon_mask &   (HLT_EGamma_mask | HLT_DoubleEG_mask)]
	elif 'MuonEG' in file:
		arrays = arrays[~HLT_SingleMuon_mask & ~HLT_DoubleMuon_mask &  ~(HLT_EGamma_mask | HLT_DoubleEG_mask) & (HLT_MuonEG1_mask | HLT_MuonEG2_mask)]
	else:
		arrays = arrays[HLT_SingleMuon_mask | HLT_DoubleMuon_mask |  HLT_EGamma_mask | HLT_DoubleEG_mask | HLT_MuonEG1_mask | HLT_MuonEG2_mask]
	return arrays
	...
	# -- Processing and Filling hist if MC
		...
		if file_basename == "LLWA_aQGC_UL18_Skim.root":
			...
			for i in range(len_weight):
				...
				arrays[f'true_weight_Rwt{i}'] = arrays['puWeight'] * arrays['Muon_ID_Weight'] * arrays['Electron_ID_Weight'] * arrays['Electron_RECO_Weight'] * lumi * arrays['xsec'] * 1000 * arrays['Generator_weight_sgn'] * arrays["Photon_ID_Weight"] / true_events
				if channel in [0,1,2,3,4, 10,11,12,13,14, 20,21,22,23,24, 30,31,32]:
				...
				arrays_copy_nominal['true_weight_PhotonIDup_Rwt{i}']		= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		* arrays_copy_nominal['Photon_ID_Weight_UP'] 	 * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_PhotonIDdown_Rwt{i}']	 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight']    	* arrays_copy_nominal['Photon_ID_Weight_DOWN']   * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_MuonIDup_Rwt{i}']		 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight_UP'] 	* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_MuonIDdown_Rwt{i}']	 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight_DOWN']  * arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronIDup_Rwt{i}'] 		= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight_UP'] 	 * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronIDdown_Rwt{i}'] 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight_DOWN'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronRECOup_Rwt{i}'] 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight'] 	 * arrays_copy_nominal['Electron_RECO_Weight_UP'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_ElectronRECOdown_Rwt{i}'] 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight'] 	 * arrays_copy_nominal['Electron_RECO_Weight_DOWN'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_puup_Rwt{i}'] 				= arrays_copy_nominal['puWeightUp'] * arrays_copy_nominal['Muon_ID_Weight'] 	* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight'] 	 * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
				arrays_copy_nominal['true_weight_pudown_Rwt{i}'] 			= arrays_copy_nominal['puWeightDown'] * arrays_copy_nominal['Muon_ID_Weight'] 	* arrays_copy_nominal['Photon_ID_Weight']		 * arrays_copy_nominal['Electron_ID_Weight'] 	 * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * arrays_copy_nominal['xsec'] * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
		...
		#------------->  Non-Reweight
			...
			## --- 1. Fill nominal
			print("Filling nominal:")
			arrays['true_weight'] = arrays['puWeight'] * arrays['Muon_ID_Weight'] * arrays['Electron_ID_Weight'] * arrays['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays['Generator_weight_sgn'] * arrays["Photon_ID_Weight"] / true_events
			...
			## --- 2.Fill lep ID RECO up down	
			print("Filling up down:")
			arrays_copy_nominal['true_weight_PhotonIDup']     	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Photon_ID_Weight_UP']   * arrays_copy_nominal['Muon_ID_Weight']   	* arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_PhotonIDdown']   	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Photon_ID_Weight_DOWN'] * arrays_copy_nominal['Muon_ID_Weight'] 	* arrays_copy_nominal['Electron_ID_Weight'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_MuonIDup'] 	  	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight_UP'] 	 * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight'] 	  * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_MuonIDdown'] 	  	= arrays_copy_nominal['puWeight'] *  arrays_copy_nominal['Muon_ID_Weight_DOWN']  * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight'] 	  * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronIDup']   	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		 * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight_UP']   * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronIDdown'] 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		 * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight_DOWN'] * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronRECOup'] 	= arrays_copy_nominal['puWeight'] * arrays_copy_nominal['Muon_ID_Weight'] 		 * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight']  	  * arrays_copy_nominal['Electron_RECO_Weight_UP'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_ElectronRECOdown'] = arrays_copy_nominal['puWeight'] *  arrays_copy_nominal['Muon_ID_Weight'] 		 * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight']  	  * arrays_copy_nominal['Electron_RECO_Weight_DOWN'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_puup'] 			= arrays_copy_nominal['puWeightUp'] *  arrays_copy_nominal['Muon_ID_Weight'] 	 * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight']  	  * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
			arrays_copy_nominal['true_weight_pudown'] 			= arrays_copy_nominal['puWeightDown'] *  arrays_copy_nominal['Muon_ID_Weight']   * arrays_copy_nominal['Photon_ID_Weight']	* arrays_copy_nominal['Electron_ID_Weight']  	  * arrays_copy_nominal['Electron_RECO_Weight'] * lumi * xsec * 1000 * arrays_copy_nominal['Generator_weight_sgn'] / true_events
