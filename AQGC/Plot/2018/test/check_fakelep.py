...
hist_sys_up = tree['WZG_WZG_mllla_FakeLepton_sys_up'].to_numpy()
hist_sys_down = tree['WZG_WZG_mllla_FakeLepton_sys_down'].to_numpy()

hist_stat_up = tree['WZG_WZG_mllla_FakeLepton_stat_up'].to_numpy()
hist_stat_down = tree['WZG_WZG_mllla_FakeLepton_stat_down'].to_numpy()
