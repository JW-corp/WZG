...
universe   = vanilla
executable = UL16Pre_run_aQGC_all.sh
...
transfer_input_files       = ${GRID_PATH},${PROXY_PATH},/hcp/home/jwkim2/2016Pre/randomizeSeeds.py,/hcp/home/jwkim2/tools/NeutrinoE-10/filepath_Neutrino_E-10_gun_2016Pre.txt
