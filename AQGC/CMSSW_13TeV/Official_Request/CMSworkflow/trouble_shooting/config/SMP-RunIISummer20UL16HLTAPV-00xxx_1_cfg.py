...
# with command line options: --python_filename SMP-RunIISummer20UL16HLTAPV-00xxx_1_cfg.py --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --fileout file:SMP-RunIISummer20UL16HLTAPV-00xxx.root --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:25ns15e33_v4 --geometry DB:Extended --filein file:SMP-RunIISummer20UL16DIGIPremixAPV-00xxx.root --era Run2_2016 --no_exec --mc -n 50
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL16DIGIPremixAPV-00xxx.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16HLTAPV-00xxx.root'),
