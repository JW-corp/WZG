        ...
        do
          ...
          if [[ $model = *[!\ ]* ]]; then
            ...
            if [[ $model == *".zip"* ]]; then
			  ...
			  echo "#################### Additional Restict file will be added !!! ##################"
			  ls -alh ../
			  # >>>>Added for dim-6 study
	  		  cp /x5/cms/jwkim/Generator/Genproduction/aQGC_WZG_v2/genproductions/bin/MadGraph5_aMCatNLO/reweight_dim6/WZA_WToLNu_LOaQGC_dim6/restrict_WZA_WToLNu_LOaQGC_dim6.dat ../models/SMEFTsim_U35_MwScheme_UFO
	  		  # <<<<<<
            else 
