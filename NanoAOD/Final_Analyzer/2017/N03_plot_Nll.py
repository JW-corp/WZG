...
for infile in flist:
	...
	#plt.savefig("cards_SR_2017/NLL_scan_{0}.png".format(param_name))
	plt.savefig("cards_SR_2017/NLL_scan_{0}.pdf".format(param_name))
	#plt.show()
	plt.close()
