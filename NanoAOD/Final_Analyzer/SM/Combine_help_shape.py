...
class region_combine():
    ...
    def __init__(self, config_json=None, utils=None, **kwargs):
        ...
        self.df_nominal = uproot.open(f'store/weight_tuned_FakeLepSysadded/{self.file_name}')
    ...
    def cal_shape_input(self, f):
        ...
        shape_string = f'shapes * {self.region_plotname} store/weight_tuned_FakeLepSysadded/{self.file_name} {self.region_name}_{self.variable}_$PROCESS_None {self.region_name}_{self.variable}_$PROCESS_$SYSTEMATIC'
        f.write(f'{shape_string}\n')
        # f.write('----------\n')
        data_shape_string = f'shapes data_obs {self.region_plotname} store/weight_tuned_FakeLepSysadded/{self.file_name} {self.region_name}_{self.variable}_data_None'
