...
file_list	   	= data_dict_FakeLep.file_list_2016_M
file_WJets	  	= data_dict_FakeLep.file_WJets_2016
file_ZJets	  	= data_dict_FakeLep.file_ZJets_2016
file_ZJets2	 	= data_dict_FakeLep.file_ZJets2_2016
file_list_QCD   = data_dict_FakeLep.file_list_QCD_2016_M
...
##c1.SaveAs('Fake_Lepton/2016/eta_TightElectron_dist_MR_2016_new.pdf')
##c1.SaveAs('Fake_Lepton/2016/eta_TightElectron_dist_MR_2016_new.png')
##c1.SaveAs('Fake_Lepton/2016/MET_FakeElectron_dist_MR_2016_new.pdf')
##c1.SaveAs('Fake_Lepton/2016/MET_FakeElectron_dist_MR_2016_new.png')
...
c1.Draw()
CMS_lumi(c1,0,0)
c1.SaveAs('Muon_FakeRate_2016.png')

file1 = ROOT.TFile("Mu_Fake_Rate_2D_2016.root","recreate")
file1.cd()
fake_rate_mu.Write()
file1.Close()
c1.Close()
...
c1.SaveAs('Muon_FakeRate_valid_2016.png')
c1.SaveAs('Muon_FakeRate_valid_2016.pdf')
c1.Close()


file1 = ROOT.TFile("Closure_Mu_Fake_Rate_2D_2016.root","recreate")
file1.cd()
...
c1.SaveAs('Closure_FR_Muon_datavsQCD_pt_2016.pdf')
c1.SaveAs('Closure_FR_Muon_datavsQCD_pt_2016.png')
