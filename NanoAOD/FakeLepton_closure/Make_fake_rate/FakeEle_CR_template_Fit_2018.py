...
file_list	   = data_dict_FakeLep.file_list_2018_E
...
file_list_QCD   = data_dict_FakeLep.file_list_QCD_2018_E
...
c1.Draw()
CMS_lumi(c1,0,0)
c1.SaveAs('Electron_FakeRate_2018.png')

file1 = ROOT.TFile("Ele_Fake_Rate_2D_2018.root","recreate")
file1.cd()
fake_rate_e.Write()
file1.Close()
...
c1.SaveAs('Electron_FakeRate_valid_2018.png')
c1.SaveAs('Electron_FakeRate_valid_2018.pdf')


file1 = ROOT.TFile("Ele_Fake_Rate_2D_closure2018.root","recreate")
file1.cd()
...
c1.SaveAs('Closure_FR_Ele_datavsQCD_pt_2018.pdf')
c1.SaveAs('Closure_FR_Ele_datavsQCD_pt_2018.png')
