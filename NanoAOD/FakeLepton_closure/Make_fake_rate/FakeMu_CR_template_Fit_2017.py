...
file_list	   	= data_dict_FakeLep.file_list_2017_M
...
file_list_QCD   = data_dict_FakeLep.file_list_QCD_2017_M
...
c1.Draw()
CMS_lumi(c1,0,0)
c1.SaveAs('Muon_FakeRate_2017.png')

file1 = ROOT.TFile("Mu_Fake_Rate_2D_2017.root","recreate")
file1.cd()
fake_rate_mu.Write()
file1.Close()
c1.Close()
...
c1.SaveAs('Muon_FakeRate_valid_2017.png')
c1.SaveAs('Muon_FakeRate_valid_2017.pdf')
c1.Close()


file1 = ROOT.TFile("Mu_Fake_Rate_2D_closure2017.root","recreate")
file1.cd()
...
c1.SaveAs('Closure_FR_Muon_datavsQCD_pt_2017.pdf')
c1.SaveAs('Closure_FR_Muon_datavsQCD_pt_2017.png')
