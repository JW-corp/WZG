...
file_list	   = data_dict_FakeLep.file_list_2016_E
...
file_list_QCD   = data_dict_FakeLep.file_list_QCD_2016_E
...
def AddHist_FTdist(file, branch, hist_pre1, hist_pre2, isData, xsec):
	...
	if isData:
		...
		weight_lowpt = (1000*xsec*lumi_Ele12) / true_events
...
c1.Draw()
CMS_lumi(c1,0,0)
c1.SaveAs('Electron_FakeRate_2016.png')
...
for i in range(len(file_list_QCD)):
	AddHist_FR_Ele(file_list_QCD[i],h_nume_e_valid,h_deno_e_valid,1,0,lumi_Ele12,lumi_Ele23, xsec_list_QCD[i])
...
c1.SaveAs('Electron_FakeRate_valid_2016.png')
c1.SaveAs('Electron_FakeRate_valid_2016.pdf')


file1 = ROOT.TFile("Closure_Ele_Fake_Rate_2D_2016.root","recreate")
file1.cd()
...
c1.SaveAs('Closure_FR_Ele_datavsQCD_pt_2016.pdf')
c1.SaveAs('Closure_FR_Ele_datavsQCD_pt_2016.png')
