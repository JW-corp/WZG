...
if __name__ == "__main__":
	...
	### >> REAL TEMPLATE ###
	with open('N01_Closure_test_results/pickle_dict_sample/real_hist_dict_16.pickle','rb') as fr:
		hist_mctruth_picke	 = pickle.load(fr)
	
	# real template unc --
	#with open('pickle_dict_sample/real_ZG_hist_dict.pickle','rb') as fr:
	#	hist_mctruth_picke	 = pickle.load(fr)
	#with open('pickle_dict_sample/real_WZG_hist_dict.pickle','rb') as fr:
	#	hist_mctruth_picke	 = pickle.load(fr)


	### >> FAKE TEMPLATE ###
	with open('N01_Closure_test_results/pickle_dict_sample/fake_hist_dict_16.pickle','rb') as fr:
		hist_datafake_pickle   = pickle.load(fr)
	# SB  unc --		
	
	#with open('pickle_dict_sample/fake_hist_high_dict_16.pickle','rb') as fr:
	#	hist_datafake_pickle   = pickle.load(fr)

	#with open('pickle_dict_sample/fake_hist_low_dict_16.pickle','rb') as fr:
	#	hist_datafake_pickle   = pickle.load(fr)

	### >> DATA TEMPLATE ###
	with open('N01_Closure_test_results/pickle_dict_sample/data_hist_dict_16.pickle','rb') as fr:
	...
	if closure:
		with open('N01_Closure_test_results/pickle_dict_sample/hist_true_fake_dict_16.pickle','rb') as fr:
			hist_true_fake_pickle  = pickle.load(fr)

		with open('N01_Closure_test_results/pickle_dict_sample/hist_true_real_dict_16.pickle','rb') as fr:
	...
	if closure:
		outname = sb + '_' +  region +'_AfterFit_16.png'
	else:
		outname = region + '_AfterFit_16.png'


	outdir='fit_out_images_AfterFit_16'
	Path(outdir).mkdir(exist_ok=True,parents=True)
	outpath = outdir + '/' + outname
	c1.Print(outpath)
