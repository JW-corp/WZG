			...
			for ptname,ptrange in pt_dicts.items(): # [ptMin, ptMax, EBorEE]
				...
				if closure:
					...
					for file in filelist_pseudo_data:
						...
						AddHist_dataFake(filelist_pseudo_data[file]['path'], hist_datafake, ptrange, ptrange[-1],sb,closure,filelist_pseudo_data[file]['xsec'], 41.5)
...
if __name__ == "__main__":
	...
	if args.template == 'fake':
		...
		with open('pickle_dict_sample/fake_hist_dict_16.pickle','wb') as fw:
	...
	if args.template == 'data':
		...
		if closure:
			...
			with open('pickle_dict_sample/data_hist_dict_16.pickle','wb') as fw:
				pickle.dump(hist_data_dict,fw)
			with open('pickle_dict_sample/hist_true_fake_dict_16.pickle','wb') as fw:
				pickle.dump(hist_true_fake_dict,fw)
			with open('pickle_dict_sample/hist_true_real_dict_16.pickle','wb') as fw:
	...
	#	with open('pickle_dict_sample/real_hist_dict_16.pickle','wb') as fw:
	#		pickle.dump(hist_mctruth_dict,fw)

	# -- True template uncertainty -- #
		with open('pickle_dict_sample/real_WZG_hist_dict_16.pickle','wb') as fw:
			pickle.dump(hist_mctruth_dict,fw)
	#	with open('pickle_dict_sample/real_ZG_hist_dict_16.pickle','wb') as fw:
	#		pickle.dump(hist_mctruth_dict,fw)
