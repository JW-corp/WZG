...
#		 2018 is special
	...
	#df = pd.read_csv("/cms/ldap_home/jwkim2/New_ccp/Analysis/check_IsoChg_for_SBUnv/centerX_18.csv",header=None,delimiter="\s+",names=['ptbins','center_x'],index_col='ptbins')
...
if __name__ == "__main__":
	...
	if args.template == 'fake':
		...
		with open('pickle_dict_sample/fake_hist_dict_18.pickle','wb') as fw:
			pickle.dump(hist_datafake_dict,fw)

		# -- SB Unc -- #
		#with open('pickle_dict_sample/fake_hist_high_dict_18.pickle','wb') as fw:
		#	pickle.dump(hist_datafake_dict,fw)

		#with open('pickle_dict_sample/fake_hist_low_dict_18.pickle','wb') as fw:
		#	pickle.dump(hist_datafake_dict,fw)
	...
	if args.template == 'data':
		...
		if closure:
			...
			with open('pickle_dict_sample/data_hist_dict_18.pickle','wb') as fw:
				pickle.dump(hist_data_dict,fw)
			with open('pickle_dict_sample/hist_true_fake_dict_18.pickle','wb') as fw:
				pickle.dump(hist_true_fake_dict,fw)
			with open('pickle_dict_sample/hist_true_real_dict_18.pickle','wb') as fw:
