...
class ApplyWeightFakeLeptonProducer(Module):
	def __init__(self,year):
		self.year = year
		if self.year == '2018':
			self.file_ele_path = '/cms/ldap_home/jwkim2/New_ccp/FakeLepton_hist/2018/Ele_Fake_Rate_2D_2018_v9.root'
			self.file_mu_path  = '/cms/ldap_home/jwkim2/New_ccp/FakeLepton_hist/2018/Mu_Fake_Rate_2D_2018_v9.root'
		elif self.year == '2017':
			self.file_ele_path = '/cms/ldap_home/jwkim2/New_ccp/FakeLepton_hist/2017/Ele_Fake_Rate_2D_2017_v9.root'
			self.file_mu_path  = '/cms/ldap_home/jwkim2/New_ccp/FakeLepton_hist/2017/Mu_Fake_Rate_2D_2017_v9.root'
		elif self.year == '2016':
			self.file_ele_path = '/cms/ldap_home/jwkim2/New_ccp/FakeLepton_hist/2016/Ele_Fake_Rate_2D_2016.root'
			self.file_mu_path  = '/cms/ldap_home/jwkim2/New_ccp/FakeLepton_hist/2016/Mu_Fake_Rate_2D_2016.root'
		pass
	def beginJob(self):
		self.FR_E = ROOT.TH2F()
		self.FR_M = ROOT.TH2F()
		...
		#self.FR_E = self.file_ele.Get('fake_rate_e_valid')
		#self.FR_M = self.file_mu.Get('fake_rate_mu_valid')
		pass
	def endJob(self):
		pass
	def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
		...
		self.out.branch("fake_lepton_weight_sys_up",  "F")
		self.out.branch("fake_lepton_weight_sys_down",  "F")
	...
	def analyze(self, event):
		...
		if event.region_mark == 2: 
			...
			for i in fake_muons:
				...
				weight_sys_up 		= 1.3 * weight_sys_up * temp_weight/(1 - temp_weight)
				weight_sys_down 	= 0.7 * weight_sys_up * temp_weight/(1 - temp_weight)
		...
		self.out.fillBranch("fake_lepton_weight_sys_up", weight_sys_up)
		self.out.fillBranch("fake_lepton_weight_sys_down", weight_sys_down)
