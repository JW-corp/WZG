...
if args.isdata:
    if args.year == '2018':
        ...
        Modules = [muonScaleRes2018(),first_Template_Module(),jetmetCorrector(),WZG_select_Module_18_torino()]
    if args.year == '2017':
    ...
    if args.year == '2018':
        ...
        Modules = [countHistogramsProducer(),muonScaleRes2018(),first_Template_Producer(),puAutoWeight_2018(),muonIDISOSF2018(),eleRECOSF2018(),eleIDSF2018(),jetmetCorrector(),WZG_select_Module_18_torino()]
    if args.year == '2017':
