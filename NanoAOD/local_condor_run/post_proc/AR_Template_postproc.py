...
if args.isdata:
    ...
    if args.year == '2016':
        ...
        Modules = [muonScaleRes2016b(),FakeLep_first_Template_Module(),jetmetCorrector(),ApplyRegionFakeLeptonModule_16()]
    if args.year == '2016_preVFP':
        ...
        Modules = [muonScaleRes2016a(),FakeLep_first_Template_Module(),jetmetCorrector(),ApplyRegionFakeLeptonModule_16()]
else:
    if args.year == '2018':
    ...
    if args.year == '2016':
        ...
        Modules = [countHistogramsProducer(),muonScaleRes2016b(),FakeLep_first_Template_Module(),puAutoWeight_2016(),PrefCorrUL16_postVFP(),muonIDISOSF2016(),eleRECOSF2016(),eleIDSF2016(),jetmetCorrector(),ApplyRegionFakeLeptonModule_16()]
    if args.year == '2016_preVFP':
        jetmetCorrector = createJMECorrector(isMC=True, dataYear="UL2016_preVFP", jesUncert="Total", metBranchName="MET", splitJER=False)
        Modules = [countHistogramsProducer(),muonScaleRes2016a(),FakeLep_first_Template_Module(),puAutoWeight_2016(),PrefCorrUL16_preVFP(),muonIDISOSF2016_preVFP(),eleRECOSF2016_preVFP(),eleIDSF2016_preVFP(),jetmetCorrector(),ApplyRegionFakeLeptonModule_16()]
