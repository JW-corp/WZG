...
def get_fake_fraction(h1,Closure_bin,histname):
	...
	if sum((np_hist[0])) !=0:
		...
		fake_fraction = sum_others/total
...
if __name__ == "__main__":
	...
	file_name = "210726_FakeTemplate_closure_data"
	...
	#	'DY'	  : lumi_factor * 1000  * xsecDict['DY'] / GenDict['DY'],
		...
		'WJets' : lumi_factor * 1000  * xsecDict['WJets'] / GenDict['WJets'],
		'DYJets' : lumi_factor * 1000  * xsecDict['DYJets'] / GenDict['DYJets'],
