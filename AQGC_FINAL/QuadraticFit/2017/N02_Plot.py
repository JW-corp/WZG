...
def Plot():
	...
	file_hist = ROOT.TFile(f'./test/WZG.root',"OPEN")
	hist_data = {}
	...
	for branch_name in branch:
		...
		null1 = ROOT.TH2F("null1","", 2, 300, 3000, 2, 0.1,50)

		null1.SetYTitle('events/bin')
		null1.SetStats(0)

		# Adjust y-axis settings
		# hist.GetYaxis().SetNdivisions(105)
		null1.GetYaxis().SetTitleSize(45)
		null1.GetYaxis().SetTitleFont(43)
		#null1.GetYaxis().SetTitleOffset(1.65)
		null1.GetYaxis().SetLabelFont(43)
		null1.GetYaxis().SetLabelSize(38)
		#null1.GetYaxis().SetLabelOffset(0.015)
		# Adjust x-axis settings
		null1.GetXaxis().SetTitleSize(45)
		null1.GetXaxis().SetTitleFont(43)
		#null1.GetXaxis().SetTitleOffset(3.3)
		null1.GetXaxis().SetLabelFont(43)
		null1.GetXaxis().SetLabelSize(0)
		#null1.GetXaxis().SetLabelOffset(0.015)
		null1.Draw();
		...
		if not (channel in [0,1,2,3,4]):
			...
			hist_data[plot_branch].SetMaximum(1.5*hist_data[plot_branch].GetMaximum())
			...
			MC_err.SetMaximum(math.ceil(2.5 * MC_err.GetMaximum()))
			MC_err.Draw("e2")
			stack_mc.Draw("HIST SAME")
		...
		pad2.cd()
		null2 = ROOT.TH2F("null2","", 2, 300, 3000, 1, 0.5,1.5)
		null2.SetLineColor(kBlack)
		null2.SetMarkerStyle(21)
		null2.SetTitle("")
		null2.SetMinimum(0.50)
		null2.SetMaximum(1.50)
		null2.Sumw2()
		null2.SetStats(0)
		...
		# Adjust x-axis settings
		x = null2.GetXaxis()
		x.SetTitle(f"{branch[branch_name]['axis_name']}")
		x.SetTitleSize(35)
		x.SetTitleFont(43)
		...
		#h3.GetXaxis().SetRangeUser(300,1000)
		#h4.GetXaxis().SetRangeUser(300,1000)
		ROOT.gPad.RedrawAxis()
