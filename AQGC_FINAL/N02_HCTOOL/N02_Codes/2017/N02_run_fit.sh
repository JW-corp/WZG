...
echo "start fit......${i} "
cardname="cards_SR_2017/aQGC_card_SR_mlllA_bin2.txt"



scalename="/cms/ldap_home/jwkim2/New_ccp/plot/2017/aQGC_dim8/ratios/${i}_ratio.npy"
outname="cards_SR_2017/${i}.root"
...
source fit_${i}.sh
mv higgsCombineTest.MultiDimFit.mH120.root "cards_SR_2017/${i}.root"
rm fit_${i}.sh
done
